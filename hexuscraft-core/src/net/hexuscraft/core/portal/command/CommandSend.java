...
public class CommandSend extends BaseCommand<CorePortal> {
    ...
    public void run(CommandSender sender, String alias, String[] args) {
        ...
        //        _miniPlugin._hexusPlugin.runAsync(() -> _miniPlugin.teleportAsync(target.getUniqueId(), server
        //        ._name));
        _miniPlugin.sendProxyMessage("ConnectOther", target.getName(), server._name);
    }
