...
public final class ServerManager
{
    ...
    public Optional<Thread> startServer(final UnifiedJedis jedis,
                                        ...
                                        final String reason)
    {
        ...
        try
        {
            final Process process = new ProcessBuilder(_path + "/Scripts/StartServer.cmd",
    ...
    public void killServer(final UnifiedJedis jedis,
                           ...
                           final String reason)
    {
        ...
        try
        {
            final Process process = new ProcessBuilder(_path + "/scripts/killServer.cmd",
                                                       serverName,
