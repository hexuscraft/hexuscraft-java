...
public final class MiniPluginScoreboard extends MiniPlugin<HexusPlugin> {
    ...
    public void onEnable() {
        for (Player player : _hexusPlugin.getServer()
                .getOnlinePlayers()) {
    ...
    public void onDisable() {
        for (Player player : _hexusPlugin.getServer()
                .getOnlinePlayers()) {
            onPlayerQuit(new PlayerQuitEvent(player,
                    null));
        }
    ...
    public void onPlayerJoin(final PlayerJoinEvent event) {
        ...
        final Scoreboard scoreboard = _hexusPlugin.getServer()
                .getScoreboardManager()
                .getNewScoreboard();
        player.setScoreboard(scoreboard);
        _scoreboardMap.put(player,
                scoreboard);
    }
    ...
    public void onPlayerQuit(final PlayerQuitEvent event) {
        final Player player = event.getPlayer();
        player.setScoreboard(_hexusPlugin.getServer()
                .getScoreboardManager()
                .getMainScoreboard());
