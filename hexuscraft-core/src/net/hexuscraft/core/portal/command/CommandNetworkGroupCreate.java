...
public final class CommandNetworkGroupCreate extends BaseCommand<MiniPluginPortal> {
    ...
    public void run(final CommandSender sender, final String alias, final String[] args) {
        ...
        try {
            name = args[0];
            if (name.length() > 100) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "Name",
                    "Length too long (must be between 1-100 characters)");
            if (name.isEmpty()) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "Name",
            ...
            if (minPort < 1) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "Min Port #",
                    "Port too small (must be between 1-65535)");
            if (minPort > 65535) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "Min Port #",
                    "Port too small (must be between 1-65535)");
            ...
            if (maxPort < 1) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "Max Port #",
                    "Port too small (must be between 1-65535)");
            if (maxPort > 65535) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "Max Port #",
                    "Port too small (must be between 1-65535)");
            ...
            if (totalServers < 0) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "Total Servers",
            ...
            if (joinableServers < 0) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "Joinable Servers",
                    "Number too small (must be greater than 0)");

            plugin = args[6];
            if (plugin.length() > 100) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "Plugin",
                    "Length too long (must be between 1-100 characters)");
            if (plugin.isEmpty()) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "Plugin",
                    "Length too short (must be between 1-100 characters)");
            ...
            worldZip = args[7];
            if (worldZip.length() > 100) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "World Zip",
                    "Length too long (must be between 1-100 characters)");
            if (worldZip.isEmpty()) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "World Zip",
                    "Length too short (must be between 1-100 characters)");
            for (final String characters : DISALLOWED_CHARACTERS) {
            ...
            if (ram < 1) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "Ram",
                    "Number too small (must be greater than 0)");
            ...
            if (capacity < 0) throw new InvalidNetStatGroupCreateArgumentException(this,
                    "Capacity",
            ...
            else games = Arrays.copyOfRange(args,
                    12,
                    args.length);
            final List<String> availableGameTypeNames = Arrays.stream(GameType.values())
                    .map(GameType::name)
                    .toList();
    ...
    private static final class InvalidNetStatGroupCreateArgumentException extends Exception {
        ...
        private String constructMessage() {
            return F.fMain(_command,
                    F.fError("Invalid argument ",
                            F.fItem(_argument),
                            ": "),
                    F.fItem(_reason));
        }
