...
public enum CharacterBlock
{
    ...
    B(List.of(new Vector2(0, 0), new Vector2(1, 0), new Vector2(2, 0),
    ...
    C(List.of(new Vector2(0, 0), new Vector2(1, 0), new Vector2(2, 0), new Vector2(3, 0),
    ...
    D(List.of(new Vector2(0, 0), new Vector2(1, 0), new Vector2(2, 0),
    ...
    E(List.of(new Vector2(0, 0), new Vector2(1, 0), new Vector2(2, 0), new Vector2(3, 0),
    ...
    F(List.of(new Vector2(0, 0), new Vector2(1, 0), new Vector2(2, 0), new Vector2(3, 0),
    ...
    G(List.of(new Vector2(0, 0), new Vector2(1, 0), new Vector2(2, 0), new Vector2(3, 0),

              new Vector2(0, 1),

              new Vector2(0, 2), new Vector2(2, 2), new Vector2(3, 2),
