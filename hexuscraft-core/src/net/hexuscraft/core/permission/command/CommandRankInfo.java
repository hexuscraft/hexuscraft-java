        ...
        _miniPlugin._hexusPlugin.runAsync(() ->
                                          {
                                              ...
                                              if (offlinePlayer.isOnline())
                                              {
                                                  ...
                                                  if (_miniPlugin._permissionProfiles.containsKey(player))
                                                  {
                                                      sender.sendMessage(F.fMain(this,
                                                                                 ...
                                                                                 " Permission Groups: ",
                                                                                 F.fItem(Arrays.stream(_miniPlugin._permissionProfiles.get(
                                                                                                       player)._groups())
                                              ...
                                              catch (final JedisException ex)
                                              {
                                                  sender.sendMessage(F.fMain(this,
                                                                             F.fError(
                                                                                     "An exception occurred while fetching the permission groups of ",
                                                                                     F.fItem(offlinePlayer.getName()),
                                              ...
                                              sender.sendMessage(F.fMain(this,
                                                                         ...
                                                                         F.fItem(groupNames.stream()
                                                                                           .map(s -> F.fPermissionGroup(
                                                                                                   PermissionGroup.valueOf(
                                                                                                           s)))
                                                                                           .toArray(String[]::new))));
                                          });
    }
