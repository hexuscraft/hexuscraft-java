...
public final class HubNews extends MiniPlugin<Hub> {
    ...
    public void onEnable() {
        _coreDatabase._database.registerConsumer(NewsUpdatedMessage.CHANNEL_NAME,
                (_, _, rawMessage) -> {
        ...
        _coreDatabase._database.registerConsumer(NewsDeletedMessage.CHANNEL_NAME,
                (_, _, rawMessage) -> {
        ...
        _coreCommand.register(new CommandNews(this,
                _coreDatabase));
    }
    ...
    private void onPlayerJoin(final PlayerJoinEvent event) {
        ...
        _bossBars.put(player,
                _coreBossBar.registerBossBar(new BossBar(player,
                        0,
                        "<news loading>")));
    }
