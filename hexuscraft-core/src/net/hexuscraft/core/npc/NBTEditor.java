...
public final class NBTEditor {
    ...
    static {
        ...
        try {
            if (LOCAL_VERSION.lessThanOrEqualTo(MinecraftVersion.v1_16)) {
                ...
                classCache.put("Entity", Class.forName("net.minecraft.world.npc.Entity"));
                classCache.put("EntityLiving", Class.forName("net.minecraft.world.npc.EntityLiving"));
                ...
                classCache.put("TileEntity", Class.forName("net.minecraft.world.level.block.npc.TileEntity"));
                classCache.put("TileEntitySkull", Class.forName("net.minecraft.world.level.block.npc.TileEntitySkull"));
            }
            ...
            classCache.put("CraftEntity", Class.forName("org.bukkit.craftbukkit." + VERSION + ".npc." + "CraftEntity"));
    ...
    public static ItemStack getHead(String skinURL) {
        ...
        try {
            ...
            Object textureProperty = getConstructor(getNMSClass("Property")).newInstance("textures", new String(
                    Base64.getEncoder()
    ...
    public static String getTexture(ItemStack head) {
        ...
        try {
            ...
            Collection<Object> properties =
                    (Collection<Object>) getMethod("values").invoke(getMethod("getProperties").invoke(profile));
    ...
    /**
     * Gets an NBT tag in a given npc with the specified keys
     *
     * @param entity The npc to get the keys from
     * @param keys   The keys to fetch; an integer after a key value indicates that it should get the nth place of
     *               the previous compound because it is a list;
     * @return The item represented by the keys, and an integer if it is showing how long a list is.
     */
    ...
    /**
     * Gets an NBTCompound from the npc provided. Use {@link #getNBTCompound(Object, Object...)} instead.
     *
     * @param entity The Bukkit npc provided
     * @param keys   Keys in descending order
     * @return An NBTCompound
     */
    ...
    /**
     * Sets an NBT tag in an npc with the provided keys and value
     * Should use the {@link #set(Object, Object, Object...)} method instead
     *
     * @param entity The npc to set
     * @param value  The value to set
     * @param keys   The keys to set, String for NBTCompound, int or null for an NBTTagList
     */
    ...
    private static Object getCompound(Block block) {
        try {
            ...
            Object blockPosition =
                    getConstructor(getNMSClass("BlockPosition")).newInstance(location.getBlockX(), location.getBlockY(),
                            location.getBlockZ());
